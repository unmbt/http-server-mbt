...
2. CLI rejection testing (http-server-min with unsupported options)
...
- [x] Task 1: Symbol isolation audit via dumpbin (strictly 5 hs_* exports, 0 main, 0 moonbit_*, 0 mbedtls/psa in min static lib)
