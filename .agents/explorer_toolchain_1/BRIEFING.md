...
- **Key findings**:
  ...
  - Windows DLL export tested successfully using `link.exe /DLL /DEF:hs_min.def /OUT:hs_min.dll /IMPLIB:hs_min.lib` yielding pure `hs_*` exports (0 main, 0 mbedtls in min).
