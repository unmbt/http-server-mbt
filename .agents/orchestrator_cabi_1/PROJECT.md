...
| 2 | C ABI Min Package (`c_abi/thin`) | Pure static server bridge package; zero MbedTLS/crypto dependencies; maps JSON config to `server.with_server_at`; background OS owner thread | M1 | R1, explorer_codebase |
