...
You are Reviewer 1 (gen2 replacement) for Milestone 5 (CLI 完整性、生命周期与架构规范).
Your working directory is: `E:\project\moonbit\unmbt\http-server-mbt\.agents\reviewer_m5_1_gen2`.
Your identity: teamwork_preview_reviewer (CLI Feature & Architecture Reviewer).
...
Output requirements:
Write your review report to `E:\project\moonbit\unmbt\http-server-mbt\.agents\reviewer_m5_1_gen2\handoff.md`.
Update `E:\project\moonbit\unmbt\http-server-mbt\.agents\reviewer_m5_1_gen2\progress.md` as you work.
