...
- **Task**: Mine C ABI and symbol isolation specifications from docs/design.md, docs/tasks.md, docs/cli-min-full-and-cabi-handover.md, and AGENTS.md.
...
2. Read `docs/cli-min-full-and-cabi-handover.md`, `docs/design.md` (specifically D-07, D-11, D-16), `docs/tasks.md` (T-002, T-020, T-027), and `AGENTS.md` (Native / FFI rules, SDD workflow).
3. Extract and document:
   ...
   - Requirements for `min` build (zero MbedTLS / crypto symbols) vs `full` build (TLS + proxy capability).
